...
<TR>
	<TD ALIGN="left">$__pass<TD ALIGN="left"><p><input class="textbox" type="password" id="pass1" name="pass1" onchange="check_pass(pass1.value,pass2.value,regi)">*</p>
<TR>
	<TD ALIGN="left">$__cnf_pass<TD ALIGN="left"><p><input class="textbox" type="password" id="pass2" name="pass2" onchange="check_pass(pass1.value,pass2.value,regi)">*</p>
	<div style="font-weight: bold; color: red;" id="IMG1"></div>
<TR>
	<TD ALIGN="left">$__email<TD ALIGN="left"><p><input class="textbox" type="text" name="mail1" id="mail1" onchange="check_mail(mail1.value,mail2.value,regi)">*</p>
<TR>
	<TD ALIGN="left">$__cnf_email<TD ALIGN="left"><p><input class="textbox" type="text" name="mail2" id="mail2" onchange="check_mail(mail1.value,mail2.value,regi)">*</p>
	<div style="font-weight: bold; color: red;" id="IMG2"></div>
<TR>
...
REG;
	if (isset($_GET['aj']))
		echo '<input class="button" type="button" onclick="do_reg2()" value="'.$__next.'">';
	else
		echo '<input class="button" type="submit" value="'.$__next.'">';
	if($aregtos)
		echo '<TR>
	 <TD ALIGN="left" colspan="2"><input type="checkbox" name="tos" id="tos" value="1">'.$__tos;
	foreach ($__plugins['core']['reg']['module'] as $p) include("plugin/$p.php");
	echo '
</TABLE>
</form>';
}
